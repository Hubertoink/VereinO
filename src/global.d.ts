...
declare global {
    interface Window {
        api?: {
            ...
            activityReports: {
                list: (payload?: Record<string, never>) => Promise<{ rows: Array<{ fiscalYear: number; updatedAt?: string | null; missingFields: string[]; isEmpty: boolean }> }>
