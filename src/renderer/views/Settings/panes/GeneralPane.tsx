...
import { BACKGROUND_IMAGE_OPTIONS, DATE_FORMAT_OPTIONS } from '../../../utils/appearanceOptions'
import { navItems, type NavKey } from '../../../utils/navItems'
import { getNavIcon } from '../../../utils/navIcons'
import { ThemePicker, NavigationControls } from '../components/AppearanceControls'
      ...
      <div className="card settings-card settings-pane-card">
        ...
        <div className="settings-layout-stack">
          <section className="settings-layout-panel">
            ...
            <NavigationControls navLayout={navLayout} setNavLayout={setNavLayout} navIconColorMode={navIconColorMode} setNavIconColorMode={setNavIconColorMode} />
