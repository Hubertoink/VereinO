export function buildAgentInstructions() {
  return [
    ...
    'Beispiel: Wenn Mitgliedsbeitraege bereits als Buchungen vorhanden sind und nur mit Beitragszeitraeumen verknuepft bzw. als bezahlt markiert werden sollen, nutze contribution_payment_link_draft_prepare mit den vorhandenen voucherIds. Erstelle dann keine neuen Buchungsentwuerfe.',
