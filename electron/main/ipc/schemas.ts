...
// Public IPC-schema facade. Domain modules are re-exported here so existing
// renderer, preload and main-process imports stay stable during the migration.
import {
  FileDataFields,
  hasFileData,
  hasImportFileData,
  ...
  UploadFileInput,
  VoucherAmountMode,
  VoucherBudgetAssignment,
  VoucherEarmarkAssignment,
  VoucherType
...
// KI-Verträge sind der erste ausgelagerte, eigenständige Fachbereich.
